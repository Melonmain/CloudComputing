    ...
    <main className="min-h-screen flex items-center justify-center gradient-subtle p-6 relative">
      ...
      <div className="w-full max-w-xl space-y-10">
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-lg text-muted-foreground">Deine Aufgaben, klar und einfach.</p>
        </div>

        {/* Card as plain div — no subcomponent split to avoid overflow bug */}
        <div className="bg-card border border-border/50 rounded-2xl shadow-2xl p-10 space-y-8">

          <div className="space-y-2">
            <h2 className="text-4xl font-bold text-foreground">Willkommen zurück</h2>
            <p className="text-lg text-muted-foreground">Melde dich mit deinen Zugangsdaten an.</p>
          </div>
